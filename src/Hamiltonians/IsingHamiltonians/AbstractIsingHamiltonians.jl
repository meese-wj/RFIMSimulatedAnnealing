...
abstract type AbstractZeemanIsing <: AbstractIsing end
...
@inline Zeeman_field(ham::AbstractZeemanIsing, site) = throw(MethodError(Zeeman_field, (ham, site)))
@inline _Zeeman_site_energy( ham::AbstractZeemanIsing, site, site_value ) = -Zeeman_field(ham, site) * site_value
...
@inline _Zeeman_DoF_energy_change(ham::AbstractIsing, site) = _Zeeman_site_energy(ham, site, -2 * ham[site])
